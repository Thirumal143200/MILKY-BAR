...
* **Expo Doctor Duplicate React Warning**:
  ...
  * *Status*: Expected behavior. The Next.js 14 web app requires React 18, whereas the newer Expo SDK 57 app requires React 19. They run in isolation and do not leak into each other's compile-time bundles, which is standard for mixed-framework workspaces.
